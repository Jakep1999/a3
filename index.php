            ...
            <section  id="linktoSynopsis">
                ...
                <form action="https://titan.csit.rmit.edu.au/~e54061/wp/lunardo-formtest.php" method="post" id="seatform" onsubmit="return false;">
                    ...
                    <div class="container">
                        ...
                        <div class="SelectTicketClassContainer">
                            
                            <br>
                            <label for="Standard Adult"><b>Standard or First Class:</b></label>
                            <select type="select" name="seats[TYPE]" id='seats-TYPE' onchange="calculateTotal()">
                                <option value="ticketNumber">Please select your seating type...</option>
                                <option value="STA">Standard Seating</option>
                                <option value="FC">First Class Seating</option>
                            </select>

<br><br>
                            <!-- Standard Section -->
                            <div class="TicketQTYContainer">
                                <label for="adultTicket"><b>Adult Ticket Qty:</b></label><br>
                                <input type="number" name="seats[ADU]" id='seats-ADU' onchange="calculateTotal()" min="0" max="30" />
                            </div>
                            <br>
                            <div class="TicketQTYContainer">
                                <label for="childTicket"><b>Child Ticket Qty:</b></label><br>
                                <input type="number" name="seats[CHI]" id='seats-CHI' onchange="calculateTotal()" min="0" max="30" />
                            </div> 
                            <br>
                            <div class="TicketQTYContainer">
                                <label for="ConcessionTicket"><b>Concession Ticket Qty:</b></label><br>
                                <input type="number" name="seats[CON]" id='seats-CON' onchange="calculateTotal()" min="0" max="30" />
